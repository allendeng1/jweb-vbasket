package com.jweb.schedule.config;
...
public class SwaggerDocConfig extends WebMvcConfigurationSupport{
	public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.jweb.schedule.controller";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("JWEB SCHEDULE 接口文档")//设置文档的标题
            .description("JWEB SCHEDULE 接口文档")//设置文档的描述->1.Overview
