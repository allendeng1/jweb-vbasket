...
public class SwaggerDocConfig extends WebMvcConfigurationSupport{
	public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.jweb.adminweb.controller";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("JWEB ADMIN 接口文档")//设置文档的标题
            .description("JWEB ADMIN 接口文档")//设置文档的描述->1.Overview
