package com.jweb.filestorage.config;
...
public class SwaggerDocConfig extends WebMvcConfigurationSupport{
	public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.jweb.filestorage.controller";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("JWEB FILESTORAGE	接口文档")//设置文档的标题
            .description("JWEB FILESTORAGE 接口文档")//设置文档的描述->1.Overview
