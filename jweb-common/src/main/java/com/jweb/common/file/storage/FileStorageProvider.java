...
public abstract class FileStorageProvider extends DataUtil{
	 ...
	 * @throws MyException
	 */
	public FileStorageResult save(FileBizType type, String owner, MultipartFile file, String domain) throws MyException {
		...
		String fileUrl = writeToDisk(file, type,owner, filePath, fileName, domain);
	...
	protected abstract String writeToDisk(MultipartFile file, FileBizType type, String owner, String filePath, String fileName, String domain)throws MyException;
